...
const Header2 = () => {
  ...
  return (
    <div className={`${isHomePage ? 'absolute top-0' : ''} bg-white border-b relative z-50`}>
      ...
      <div className="container-max flex items-center justify-between py-2">
        ...
        <div className="flex flex-col items-center flex-shrink-0">
          ...
          <Link to="/" className="cursor-pointer mt-1">
            <div className="flex mt-1 space-x-1 font-semibold bg-orange-200 rounded-full px-3 py-1 shadow-sm text-sm brand-font">
