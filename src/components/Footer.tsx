  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        const response = await axios.get('http://shoppuda.kro.kr:8000/api/site/settings/');
        ...
        setSettings({
          ...
          online_business_number: '제2024-서울강남-0001호',
          privacy_officer: '박수빈',
          bank_name: '신한은행',
          bank_account_number: '110-123-456789',
          bank_account_holder: '박수빈',
          hosting_provider: 'Cafe24 Corp.',
          facebook_url: '',
          instagram_url: '',
          youtube_url: '',
          twitter_url: '',
